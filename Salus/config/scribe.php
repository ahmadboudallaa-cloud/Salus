...
return [
    ...
    'description' => 'API REST pour suivre les symptomes, prendre des rendez-vous et obtenir des conseils de bien-etre generes par IA.',

    // Text to place in the "Introduction" section, right after the `description`. Markdown and HTML are supported.
    'intro_text' => <<<'INTRO'
            Cette documentation decrit les endpoints disponibles, les formats de reponses et la methode d'authentification.

            <aside>Les routes protegees exigent un header Authorization avec un token Sanctum: <code>Authorization: Bearer {token}</code>.</aside>
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Recuperez un token via /api/login puis utilisez-le dans le header Authorization.',
    ],
